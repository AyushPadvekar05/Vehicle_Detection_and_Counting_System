...
# init_tracker() Function: Initializes the deep sort tracker using a configuration file.
def init_tracker():
    global deepsort
    cfg_deep = get_config()
...
# Assigns fixed colors based on the object class label.
...
# Draws a border around a rectangle with rounded corners and ellipses.
...
# This function is used to draw bounding boxes on the image, with an optional label
...
# This function determines the direction (North, South, East, West) based on two points.
